...
namespace BulkyBook.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult GetOrderList(string status)
        {
            ...
            {
                //you are not admin or Employee, you see only your orders
            ...
            switch (status)
            {
                case "pending":
                    ...
                    break;
                case "inprocess":
                    orderHeaderList = orderHeaderList.Where
                        (o => o.OrderStatus==SD.StatusApproved||
                ...
                case "rejected":
                    orderHeaderList = orderHeaderList.Where
                        (o => o.OrderStatus == SD.StatusCancelled ||
